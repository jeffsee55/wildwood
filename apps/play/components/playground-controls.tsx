...
export function PlaygroundControls({ githubSignedIn, initial }: Props) {
  return (
    <section className="w-full max-w-3xl space-y-4">
      <div>
        <h2 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">Play controls</h2>
      ...
      <div>
        ...
        <PlaygroundConfigFormLoader githubSignedIn={githubSignedIn} initial={initial} />
      </div>
    </section>
  );
}
