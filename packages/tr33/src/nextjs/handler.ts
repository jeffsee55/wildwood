 ...
 * Zero deps on @tr33/kit, better-auth, or next/*.
 */
...
export function createHandler(client: Tr33Client, _options?: CreateHandlerOptions) {
  const base = new H3();
  const app = new H3();
 ...
 */
export function handle(client: Tr33Client, options?: CreateHandlerOptions) {
